...
import { addNewCar } from '@/app/action'
...
export const AddCar = () => {
  ...
  const [state, formAction] = useActionState(addNewCar, initialState)
        ...
        <SheetContent className="w-full sm:max-w-full lg:max-w-[800px] max-h-[100vh] overflow-y-auto p-6">
          ...
          <form action={formAction} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="name" name="name" placeholder="BMW" className="w-full" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="description" className="text-left text-sm font-medium">
                Description
              </Label>
              <Textarea placeholder="BMW is a great car" name="description" className="w-full min-h-[100px]" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input name="carType" type="text" placeholder="Sports Car" required minLength={3} className="w-full" />
            </div>
            <div className="space-y-2">
              <Label className="text-sm font-medium">Company</Label>
              <Input name="company" type="text" placeholder="BMW" required minLength={3} className="w-full" />
            </div>
            <div className="space-y-2">
              <Label className="text-sm font-medium">Dealer</Label>
              <Input name="dealer" type="text" placeholder="AutoMax" required minLength={3} className="w-full" />
            </div>
            <div className="space-y-2">
